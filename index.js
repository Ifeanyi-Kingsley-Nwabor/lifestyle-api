...
app .post('/upload-blog_images', upload.single('blog_images'), (req, res, next) => {
...
app.use((err, req, res, next) => {
    ...
    res.status(500).send("Seems you got your self in some deep shit!!! BLAME Kingsley!! He did it while messing around.");
  });
